...
class PGDBInterface:
    ...
    def __init__(self, check_environment=True,
                 config_file="../config/postgres.tsv", # Directly make changes in line 96 line 109 below, without creating a new tsv file
    ...
    def create_db_connection(self, check_environment=True,
        ...
        try:
            ...
            if remote:
                ...
                self.conn = psycopg2.connect(database='uspto_patents',
                                             user='patent_manager',
                                             password='zeipiwai1.',  # The password you set
                                             host='127.0.0.1', # Self set, usually 127.0.0.1 or localhost
                                             port='5432',
                                             sslmode='require')
            else:
                if not self.silent_logging:
                ...
                self.conn = psycopg2.connect(database='uspto_patents',
                                             user='patent_manager',
                                             password='zeipiwai1.', # Same as above
                                             host='127.0.0.1', # Same as above 
                                             port='5432')
